...
-- use jkl to exit insert mode
vim.keymap.set("i", "jk", "<ESC>l")

-- close current split window
-- vim.keymap.set("n", "<leader>sx", ":close<CR>") -- close current split window
vim.keymap.set("n", "<leader>sx", ":bdelete<CR>") -- close current split window
-- save in insert mode
...
-- This is the alt and move keymap, when in visual mode and highglited I can move the mode up and down
...
-- Keep paste inside system clipboard
vim.keymap.set("n", "<leader>y", '"+y')
vim.keymap.set("n", "<leader>Y", '"+Y')
vim.keymap.set("v", "<leader>y", '"+y')

-- A way to replicate the Alt+Up or Alt+Down arrow keys
vim.keymap.set("n", "<c-^>", ":move -2<CR>")
vim.keymap.set("n", "<c-&>", ":move +1<CR>")
